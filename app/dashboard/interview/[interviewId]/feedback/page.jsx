  ...
  return (
    <div className="p-10">
      ...
      <h2 className="text-sm text-gray-500">
        Below are your Interview questions with Correct Answers, Your Answers
          ...
          <Collapsible key={index} className='mt-7'>
            ...
            <CollapsibleContent>
              <div className="flex flex-col gap-2">
                ...
                <h2 className="p-2 border rounded-lg bg-emerald-50 text-sm text-emerald-900"><strong>Correct Answer: </strong>{item.correctAns}</h2>
